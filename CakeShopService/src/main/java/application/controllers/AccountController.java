...
public class AccountController {
    ...
    public @ResponseBody MessageOutputAdapter createAccount(@RequestBody Account account) {
    ...
    public @ResponseBody MessageOutputAdapter deleteAccount(@RequestParam String sessionKey,
            @RequestParam String sessionValue, @PathVariable String accountName) {
    ...
    public @ResponseBody MessageOutputAdapter login(@RequestParam String accountName, @RequestParam String password) {
    ...
    public @ResponseBody MessageOutputAdapter logout(@PathVariable String accountName) {
        Optional<Account> account = facade.findAccount(accountName);
        if (account.isPresent()) {
    ...
    public @ResponseBody MessageOutputAdapter getAll(@RequestParam String sessionKey,
            @RequestParam String sessionValue) {
        if (!facade.isSessionExist(sessionKey, sessionValue)) {
            return responseFactory.sessionTimeout();
        }
    ...
    public @ResponseBody MessageOutputAdapter getAccount(@RequestParam String sessionKey,
            @RequestParam String sessionValue, @PathVariable String accountName) {
        if (!facade.isSessionExist(sessionKey, sessionValue))
            return responseFactory.sessionTimeout();
        Optional<Account> account = facade.findAccount(accountName);
    ...
    public @ResponseBody MessageOutputAdapter update(@RequestParam String sessionKey, @RequestParam String sessionValue,
            @PathVariable String accountName, @RequestBody Account account) {
    ...
    public @ResponseBody MessageOutputAdapter checkSession(@RequestParam String sessionKey,
            @RequestParam String sessionValue) {
        if (facade.isSessionExist(sessionKey, sessionValue))
            return responseFactory.success();
        else
